      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Join Steero today</Text>
          </View>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
          ...
          <ScrollView style={{ flex: 1, padding: SPACING.lg }} showsVerticalScrollIndicator={false}>
            <Text style={styles.legalText}>
              {legalModal === 'privacy'
                ? 'Steero collects information you provide when creating an account, including your name, email address, phone number, and profile photo. For drivers, we also collect professional credentials, work history, and uploaded documents.\n\nWe use your information to provide the Steero service, connect car owners with drivers, verify driver credentials, and facilitate communication between users.\n\nYour profile information is visible to other Steero users. We do not sell your personal information to third parties.\n\nYour data is stored securely using industry-standard encryption. You have the right to access, correct, and delete your personal data at any time through the app settings.\n\nFor privacy-related inquiries, contact us at support@steero.app.'
                : 'By using Steero, you agree to these Terms of Service. Steero is a platform that connects car owners with professional drivers in Namibia.\n\nYou must provide accurate information when creating an account. You must be at least 18 years old to use Steero.\n\nDrivers may submit documents for verification. Verification does not constitute an endorsement or guarantee. Car owners should conduct their own due diligence.\n\nUsers agree not to provide false information, harass other users, or use the platform for illegal purposes.\n\nReviews must be honest and based on actual experience. Steero reserves the right to remove fraudulent reviews.\n\nSteero provides a platform for connecting users and is not liable for disputes between car owners and drivers.\n\nFor questions about these terms, contact us at support@steero.app.'}
            </Text>
          </ScrollView>
        </SafeAreaView>
      </Modal>
