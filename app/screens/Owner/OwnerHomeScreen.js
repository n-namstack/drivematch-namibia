  ...
  const loadData = async () => {
    try {
      ...
      Toast.show({
        ...
        text2: "Could not load data. Pull to refresh.",
      });
    }
  };
      ...
      >
        ...
        <View style={styles.quickActions}>
          ...
          >
            <View
              style={[
                styles.quickActionIcon,
                { backgroundColor: fleetTheme.colors.info + "15" },
              ]}
            >
              <Ionicons
                name="car-outline"
                size={22}
                color={fleetTheme.colors.info}
              />
            </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("AllDrivers", { showAll: true })
              }
            >
