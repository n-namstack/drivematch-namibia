...
const styles = StyleSheet.create({
  ...
  featuredBadge: {
    ...
    backgroundColor: COLORS.accent + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: BORDER_RADIUS.full,
  },
  featuredText: { fontSize: 10, fontWeight: '600', color: COLORS.accent },
  availableBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: SPACING.xs },
  ...
  availableBadgeHoriz: {
    ...
    backgroundColor: 'rgba(0,0,0,0.6)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: BORDER_RADIUS.full,
  },
